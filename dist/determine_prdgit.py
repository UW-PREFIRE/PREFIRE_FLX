...
of the provenance of this package's products ('2B-FLX'); write to file.
...
Pypackages_to_query = ("PREFIRE_FLX",)
...
if __name__ == "__main__":
    ...
    arg_description = ("Determine product monikers and current (latest) git "
                       ...
                       "package's products ('2B-FLX'); write to file.")
