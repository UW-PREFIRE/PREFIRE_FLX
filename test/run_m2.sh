...
# PROC_MODE=2 (i.e., with AUX-SAT input)
#cfg_str3="ATRACK_IDXRANGE_0BASED_INCLUSIVE:5800:5900,${input_dir}/PREFIRE_SAT1_1B-RAD_R01_P00_20241007075724_01877.nc||${input_dir}/PREFIRE_SAT1_AUX-MET_R01_P00_20241007075724_01877.nc||${input_dir}/PREFIRE_SAT1_2B-MSK_R01_P00_20241007075724_01877.nc||${input_dir}/PREFIRE_SAT1_2B-CLD_R01_P00_20241007075724_01877.nc||${input_dir}/PREFIRE_SAT1_AUX-SAT_R01_P00_20241007075724_01877.nc";
cfg_str4="ATRACK_IDXRANGE_0BASED_INCLUSIVE:6000:6100,${input_dir}/PREFIRE_SAT2_1B-RAD_R01_P00_20241007071543_02040.nc||${input_dir}/PREFIRE_SAT2_AUX-MET_R01_P00_20241007071543_02040.nc||${input_dir}/PREFIRE_SAT2_2B-MSK_R01_P00_20241007071543_02040.nc||${input_dir}/PREFIRE_SAT2_2B-CLD_R01_P00_20241007071543_02040.nc||${input_dir}/PREFIRE_SAT2_AUX-SAT_R01_P00_20241007071543_02040.nc";
...
# Processing mode #2 (PrOC_MODE=2): Create part of a 2B-FLX granule using
#                                   AUX-SAT final merged surface type
...
conda_env_dir="${this_top_dir}/dist/c_env_for_PREFIRE_FLX";
...
for cfg_str in ${cfg_str3} ${cfg_str4}
do
   ATRACK_IDX_RANGE_0BI=${cfg_str%,*};

   tmp_str=${cfg_str##*,};  # L1B, AUX-MET, 2B-MSK, 2B-CLD, [AUX-SAT]
   tmpA_str=${tmp_str%||*};  # L1B, AUX-MET, 2B-MSK, [2B-CLD]
   tmpB_str=${tmp_str##*||};  # 2B-CLD? or AUX-SAT?
   if [[ "$tmpB_str" == *"AUX-SAT"* ]]; then
      AUX_SAT_FILE=$tmpB_str;
      export AUX_SAT_FILE;
      L2B_CLD_FILE=${tmpA_str##*||};
      tmp_str=${tmpA_str%||*};  # L1B, AUX-MET, 2B-MSK
   else
      L2B_CLD_FILE=$tmpB_str;
      tmp_str=$tmpA_str;  # L1B, AUX-MET, 2B-MSK
   fi
   tmpA_str=${tmp_str%||*};  # L1B, AUX-MET
   L2B_MSK_FILE=${tmp_str##*||};
   L1B_RAD_FILE=${tmpA_str%||*};
   AUX_MET_FILE=${tmpA_str##*||};
